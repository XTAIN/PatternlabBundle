...
/*
 ...
 'patternPaths' =>
  array(2) {
    ...
    array(4) {
      'colors' =>
      string(28) "00-atoms/01-global/00-colors"
      'fonts' =>
      string(27) "00-atoms/01-global/01-fonts"
      'animations' =>
      string(32) "00-atoms/01-global/02-animations"
      'visibility' =>
      string(32) "00-atoms/01-global/03-visibility"
    }
    'molecules' =>
    array(1) {
      'test.html' =>
      string(25) "01-molecules/00-test.html"
    }
  }
...
class Util
{
    ...
    public function __construct(PatternLocator $locator) {
        $this->patternPaths = $locator->getPatternPaths();
    }
